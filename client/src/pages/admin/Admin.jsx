...
const Admin = () => {
    ...
    return (
        <Layout>
            ...
            <div className="bg-gray-500  pb-4 px-4 rounded-md w-[15rem] md:w-full md:h-auto">
                <div className="flex justify-between w-full pt-6 ">
                    <p className="ml-3"> All Bloggers Entries</p>
                ...
                <div className="w-full flex justify-end px-2 mt-2">
                    <div className="w-full sm:w-64 inline-block relative ">
                        <input type="text" className="leading-snug border border-gray-300 block w-full appearance-none bg-gray-100 text-sm text-gray-600 py-1 px-4 pl-8 rounded-lg" placeholder="Search" />
                        <div className="pointer-events-none absolute pl-3 inset-y-0 left-0 flex items-center px-2 text-red-200">
                    ...
                    <table className="table-auto border-collapse w-full">
                        <thead>
                            <tr className="rounded-lg text-sm font-medium text-gray-700 text-left" style={{ fontSize: '0.9674rem' }}>
                                <th className="px-4 py-2 bg-gray-200 " style={{ backgroundColor: '#f8f8f8' }}>IDs</th>
                                <th className="px-4 py-2 " style={{ backgroundColor: '#f8f8f8' }}>userame</th>
                                <th className="px-4 py-2 " style={{ backgroundColor: '#f8f8f8' }}>Controls</th>
                            </tr>
                        </thead>
                        <tbody className="text-sm font-normal text-white cursor-pointer">

                            <tr className="hover:bg-gray-300  hover:text-secondary-bg border-b border-gray-200 py-4">
                                <td className="px-4 py-4 flex items-center">
                                    ...
                                    #9u293293923838hhh92839</td>
                                <td className="px-4 py-4">@Shoeb</td>
                                <td className="px-4 py-4">
                                    <button className='bg bg-red-500 p-2 hover:bg-red-300  rounded-md text-white'>Remove</button>
                                </td>
                            </tr>
                            <tr className="hover:bg-gray-300  hover:text-secondary-bg border-b border-gray-200 py-4">
                                <td className="px-4 py-4 flex items-center">
